...
class Test_TTL(Simulation):
    def __init__(self, TrafficGen, Map_info, sumo_cmd, max_steps, green_duration, yellow_duration, num_states,
                 num_actions):

        super().__init__(None, Map_info, TrafficGen, sumo_cmd, max_steps, green_duration,
